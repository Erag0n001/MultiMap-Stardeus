...
SPRITES = {
    "Rock01": Sprite("Structure/Walls/Rock01", 4, 4, camera_du="TD", is_rotatable=False, lights="Wall Lights", line_sets=["Wall"]),
    "Rock01Corner": Sprite("Structure/Walls/Rock01Corner", 4, 4, camera_du="TD", is_rotatable=False, lights="Wall Lights", line_sets=["Wall"]),
}
